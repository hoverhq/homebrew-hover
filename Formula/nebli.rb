...
class Nebli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "ab48e3f66b2205a9f62dfa47d156ca57e8396201a42e8a7d572218dd7a6f6f74"
    end

    on_intel do
      url "https://downloads.hoverfeed.com/cli/versions/v#{version}/nebli-darwin-amd64.tar.gz"
      sha256 "bdd743164bcbb3cb7438cecf2b692fef24f880deeb0d03a1b00f43d5f37a8647"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "6aee683909095184118d6c5509741698bc10b85508dc968bb7121da29daaca1a"
    end

    on_arm do
      url "https://downloads.hoverfeed.com/cli/versions/v#{version}/nebli-linux-arm64.tar.gz"
      sha256 "02fc1e0698643428ab98bc2b526b5cd7f7b6864ad37453d5d6d91d07891bba8e"
    end
  end
